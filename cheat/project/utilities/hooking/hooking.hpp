...
namespace hooking {
	...
	// Inline (mid-function) hook support was intentionally not added: pastehook
	// style paint colors work with plain entry-point detours (build context +
	// AddToTail trigger), no register capture required.
