...
namespace hooking {
	...
	namespace detail {
		...
		// Shared with other hook impls (not static so it can be linked).
		bool build_trampoline( void* target, void* trampoline, std::size_t* out_original_len, std::size_t* out_trampoline_len )
		{
