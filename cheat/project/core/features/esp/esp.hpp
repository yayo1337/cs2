...
namespace features::esp {
	...
	namespace player {
		...
		public:
			...
			void clear_animations( ) { this->m_animations.clear( ); }
		...
		private:
			...
			void add_skeleton( xdraw::draw_list& draw_list, const info& info, const settings::esp::player::overlay::skeleton& cfg, bool visible );
	...
	namespace item {
		...
		private:
			...
			[[nodiscard]] info get_info( const systems::entities::cached& entity, const std::string& name );
			[[nodiscard]] std::uint32_t get_item_group( std::uint32_t schema_hash );
		};
