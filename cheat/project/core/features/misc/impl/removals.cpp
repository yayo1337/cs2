...
namespace features::misc {
	...
	{
		if ( !settings::g_misc.m_removals.enabled.value || !settings::g_misc.m_removals.skybox_fog.value )
		{
			return;
		}
	...
	{
		if ( !settings::g_misc.m_removals.enabled.value || !settings::g_misc.m_removals.recoil.value )
		{
			return;
		}
