...
namespace hooks {
	...
	public:
		...
		static void __fastcall allow_camera_angles( std::uintptr_t input, int a2 );
		...
		static void __fastcall get_viewmodel_offsets( std::uintptr_t viewmodel, float* out_offsets, float* out_fov );
		static void __fastcall viewmodel_bob( std::uintptr_t viewmodel, std::uintptr_t a2, std::uintptr_t a3 );
		...
		static std::int64_t __fastcall panorama_event( void* unk, const char* event_name, void* unk1, float unk2 );
		static ID3D11ShaderResourceView* __fastcall get_resource_view( void* texture_manager, int** texture, char a3, char a4, const char* name );
	...
	private:
		...
		inline static hooking::jmp m_allow_camera_angles{};
		...
		inline static hooking::jmp m_get_viewmodel_offsets{};
		inline static hooking::jmp m_viewmodel_bob{};
	...
	public:
		...
		static void __fastcall build_legacy_weapon_skin_material( void* weapon, bool force );
		static void __fastcall build_modern_weapon_skin_material( void* weapon, void* a2, void* a3, int a4, char a5, char a6, void* a7 );
		static void __fastcall add_to_tail( void* vector, const void* input );

	private:
		inline static hooking::jmp m_build_legacy{};
		inline static hooking::jmp m_build_modern{};
		inline static hooking::jmp m_add_to_tail{};
	};
