...
namespace tokens {
	...
	// nexoria — pitch black / carbon / lime accent.
	inline xdraw::color col_accent{ 168, 229, 29, 255 };   // lime — #A8E51D
	inline xdraw::color col_accent_dim{ 168, 229, 29, 60 };
	inline xdraw::color col_dark{ 11, 11, 11, 255 };       // #0B0B0B  window background
	inline xdraw::color col_text{ 229, 229, 229, 255 };    // #E5E5E5  primary text
	inline xdraw::color col_text_dim{ 133, 133, 133, 255 };// #858585  secondary text
	inline xdraw::color col_text_faint{ 85, 85, 85, 255 }; // #555555  disabled
	inline xdraw::color col_card{ 23, 23, 23, 255 };       // #171717  card surface
	inline xdraw::color col_elevated{ 15, 15, 15, 255 };   // sidebar / header strip
	inline xdraw::color col_surface{ 30, 30, 30, 255 };    // inputs / controls
	inline xdraw::color col_border{ 37, 37, 37, 255 };     // #252525  card border
	inline xdraw::color col_hover{ 34, 34, 34, 255 };
	inline xdraw::color col_pressed{ 46, 46, 46, 255 };

	// Layout constants for the new bento shell.
	constexpr auto window_w{ 820.0f };
	constexpr auto window_h{ 500.0f };
	constexpr auto header_h{ 44.0f };
	constexpr auto rail_w{ 190.0f };
	constexpr auto rail_icon_size{ 18.0f };
	constexpr auto subtab_bar_h{ 30.0f };
	constexpr auto gap{ 8.0f };
	constexpr auto card_rounding{ 6.0f };
	constexpr auto btn_rounding{ 5.0f };
	constexpr auto pill_rounding{ 999.0f }; // for switch pills
